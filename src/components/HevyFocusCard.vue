<template>
  ...
  >
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center gap-x-2 gap-y-0.5 mt-1.5 text-[11px] text-gray-400">
          <span class="flex items-center gap-0.5">W: <strong class="text-white">{{ item.medianMass.toFixed(2) }} kg</strong></span>
          <span class="text-gray-700">|</span>
          <span class="flex items-center gap-0.5">Lean: <strong class="text-blue-400">{{ item.medianLeanMass.toFixed(2) }} kg</strong></span>
          <span class="text-gray-700">|</span>
          <span class="flex items-center gap-0.5">Fat: <strong class="text-emerald-400">{{ item.medianFat.toFixed(1) }}%</strong></span>
          <span class="text-gray-700">|</span>
          <span class="flex items-center gap-0.5">Fat kg: <strong class="text-amber-400">{{ item.medianFatMass.toFixed(2) }} kg</strong></span>
        </div>
      </div>
    </div>
    ...
    <button
      ...
      :title="'Copy ' + periodLabel + ' Medians'"
    >
